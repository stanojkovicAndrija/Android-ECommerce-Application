...
class BillingAdapter: RecyclerView.Adapter<BillingAdapter.BillingProductsViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BillingAdapter.BillingProductsViewHolder {
